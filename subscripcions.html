...
<body>
    ...
    <div class="contenedor-formulari">
        ...
        <!-- Success Message-->
        <div id="responseSuccess" class="toast show" role="alert" aria-live="assertive" aria-atomic="true" style="color: rgb(54, 102, 54); width: 100%; max-width: 350px; display: none;">
        ...
        <!-- Error Message-->
        <div id="responseError" class="toast show" role="alert" aria-live="assertive" aria-atomic="true" style="color: rgb(97, 28, 45); width: 100%; max-width: 350px;display: none;">
